with open('APIs.txt','w', encoding='utf-8') as arquivo:
    arquivo.write('''Application Programming Interface
...
with open ("c:/Users/Elisabeth/Desktop/VINI/Python/APIs.txt",'r', encoding='utf-8') as arquivo:
