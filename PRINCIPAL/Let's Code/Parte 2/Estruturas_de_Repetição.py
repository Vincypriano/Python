with open('Estrutura_de_repetição_for.txt','w',encoding='utf-8') as arquivo:
    arquivo.write('''Percorrendo coleções
...
with open('Estrutura_de_repetição_for.txt','r',encoding='utf-8') as arquivo:
