with open('String_II.txt','w',encoding='utf-8')as arquivo:
    arquivo.write('''Uso de operadores aritméticos com strings
...
with open('String_II.txt','r',encoding='utf-8')as arquivo:
