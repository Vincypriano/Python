...
pessoas : List[Dict[str, str]] = [
    ...
    {'nome': 'Fabricio', 'sobrenome': 'Costa'},
    {'nome': 'Eduardo', 'sobrenome': 'Vieira'},
    {'nome': 'Livia', 'sobrenome': 'Madeira'},
...
if __name__ == "__main__":
    pessoa_1 = busca_pessoas(pessoas, "helena  Oliveira")
    pessoa_2 = busca_pessoas(pessoas, "João    barbosa" )
    print(pessoa_1.values())
    print(bool(pessoa_1))
    print(pessoa_2)
    print(bool(pessoa_2))
